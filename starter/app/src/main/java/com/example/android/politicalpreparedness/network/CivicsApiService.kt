...
interface CivicsApiService {
    ...
    @GET("elections")
    suspend fun getElections(): Call<List<ElectionResponse>>

    //TODO: Add voterinfo API Call
    @GET("voterinfo")
    suspend fun getVoterInfo(): Call<List<VoterInfoResponse>>

    //TODO: Add representatives API Call
    @GET("representatives")
    suspend fun getRepresentatives(): Call<List<RepresentativeResponse>>
}
